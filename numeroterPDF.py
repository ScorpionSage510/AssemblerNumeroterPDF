"""
choisir quel fichier en 1er
SANS temp + Peux tu m'ajouter un bouton pour interrompre la fusion ET la progress bar n'a pas marché, 
elle est trop rapide, je veux à la place, faire une estimation de la durée en fonction du nombre d'octets 
et afficher pendant le déroulement de la barre le temps restant Ajoute moii un bouton pour reset le 
glissement (à la place d'ajouter le fichier par dessus encore) ET la barre d'état m'affiche FULL alors 
que fusion pas finie (je veux progressivement)
